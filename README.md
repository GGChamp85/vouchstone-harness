...
- **`mcp-server/`** — a real [Model Context Protocol](https://modelcontextprotocol.io) server exposing Knowledge Graph, agent, and memory operations (32 tools + 4 resources) to any MCP client (Claude Desktop, Claude Code, OpenCode, etc.) via `@modelcontextprotocol/sdk` and stdio transport.
